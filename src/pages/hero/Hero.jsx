      ...
      <header className="py-4 md:py-6">
        <div className="container px-4 mx-auto sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden lg:flex lg:ml-6 xl:ml-10 lg:items-center lg:justify-center lg:space-x-6 xl:space-x-10">
              <Link
                to="about"
                smooth={true}
                duration={500}
        ...
        <div className="grid max-w-lg grid-cols-1 mx-auto md:max-w-2xl lg:max-w-full lg:items-center lg:grid-cols-2 gap-y-10 md:gap-y-12 lg:gap-x-16">
            <div>
              <div className="text-center lg:text-left">
                ...
                <p className="mt-4 text-sm sm:text-base md:text-lg text-center md:text-left max-w-xl px-2">
             ...
             dark:bg-cyan-500 dark:hover:bg-cyan-800 dark:focus:bg-cyan-500"
                        ...
                        <div className="flex items-center justify-center text-gray-600 dark:text-gray-300 font-inter">
