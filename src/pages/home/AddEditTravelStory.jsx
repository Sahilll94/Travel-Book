...
const AddEditTravelStory = ({
  ...
  const handleTouchStart = (e) => {
    // Ignore touches inside inputs or textareas
  ...
  useEffect(() => {
    ...
    if (isMobile && type === "add" && !autoAdvancePaused) {
  ...
  }, [formCompleted, activeStep, type, autoAdvancePaused]);
  ...
  const completionPercentage = () => {
    const totalSteps = 5;
    const completedSteps = Object.values(formCompleted).filter(
      (val) => val
    ).length;
  ...
  const handleShare = (storyId) => {
    ...
    navigator.clipboard
      ...
      .then(() => {
        toast.success(
          "Link copied to your clipboard! 🎉 Now you can share it with your friends! 😎✨"
        );
      })
      .catch(() => {
  ...
  return (
    <motion.div
      ...
      <div className="mb-4 flex flex-col sm:hidden px-3">
        <div className="flex justify-between items-center">
          <h5 className="text-base sm:text-lg font-bold text-slate-800 dark:text-white flex items-center">
            {type === "add" ? (
              <>
          ...
          <div className="flex gap-3">
            <motion.button
              className="w-10 h-10 flex items-center justify-center rounded-full bg-slate-100 dark:bg-gray-700 text-slate-500 dark:text-slate-300"
        ...
        <div className="mt-3 flex justify-between items-center">
          {[1, 2, 3, 4, 5].map((step) => (
            <div
              ...
              } h-3 rounded-lg mx-0.5 transition-all duration-300`}
            />
          ))}
        </div>

        <div className="mt-3 mb-1 text-center">
          <span className="text-sm leading-relaxed font-medium text-gray-600 dark:text-gray-300">
        ...
        <AnimatePresence>
          {showMobileNav && (
            ...
            >
              <motion.div
                className="w-full bg-white dark:bg-gray-800 rounded-t-2xl p-4 pb-20 max-h-[80vh] overflow-y-auto"
                initial={{ y: "100%" }}
                animate={{ y: 0 }}
                exit={{ y: "100%" }}
              ...
              >
                  ...
                  {[
                    {
                      ...
                      icon: <MdTitle />,
                      title: "Title",
                      completed: formCompleted.title,
                    },
                    {
                      step: 2,
                      icon: <MdCalendarToday />,
                      title: "Date",
                      completed: formCompleted.date,
                    },
                    {
                      step: 3,
                      icon: <MdImage />,
                      title: "Image",
                      completed: formCompleted.image,
                    },
                    {
                      step: 4,
                      icon: <MdDescription />,
                      title: "Story",
                      completed: formCompleted.story,
                    },
                    {
                      step: 5,
                      icon: <MdLocationOn />,
                      title: "Locations",
                      completed: formCompleted.location,
                    },
                  ].map((item) => (
                    <motion.button
                      key={item.step}
                      className={`flex items-center p-3 rounded-lg min-h-[44px] ${
                ...
                {/* Sticky Close Button */}
                <div className="mt-6 flex justify-center sticky bottom-4">
                  <motion.button
                    className="w-full bg-slate-200 dark:bg-gray-700 text-slate-700 dark:text-slate-200 px-5 py-3 rounded-lg"
      ...
      <div className="mb-6 hidden sm:block">
        ...
        {/* Progress bar */}
        <div className="w-full bg-slate-100 dark:bg-gray-700 rounded-lg h-3 mb-3 overflow-hidden">
            <motion.div
            className="bg-gradient-to-r from-cyan-400 to-cyan-600 dark:from-cyan-500 dark:to-cyan-700 h-3 rounded-lg"
        ...
        {/* Progress text */}
        <div className="text-xs sm:text-sm text-slate-500 dark:text-slate-400 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="md:col-span-1 hidden md:block">
          <div className="flex flex-col gap-3">
            <motion.div
              className={`p-4 border rounded-lg cursor-pointer dark:text-white ${getStepClass(
                1
              )} ${
                formCompleted.title
                  ? "bg-gradient-to-r from-cyan-50 to-slate-50 dark:from-cyan-900/20 dark:to-gray-800 border-cyan-200 dark:border-cyan-800"
                  : ""
              }`}
              ...
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  ...
                  <p className="text-xs text-slate-500 dark:text-slate-400">
                    {formCompleted.title ? "Completed" : "Name your adventure"}
                  </p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  ...
                  <p className="text-xs text-slate-500 dark:text-slate-400">
                    {formCompleted.date ? "Completed" : "When did you visit?"}
                  </p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  ...
                  <p className="text-xs text-slate-500 dark:text-slate-400">
                    {formCompleted.story ? "Completed" : "Tell your tale"}
                  </p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  ...
                  <p className="text-xs text-slate-500 dark:text-slate-400">
                    {formCompleted.location ? "Completed" : "Where did you go?"}
                  </p>
                </div>
              </div>
            </motion.div>
          ...
          <div className="mt-6 bg-gradient-to-br from-cyan-50 to-blue-50 dark:from-gray-800 dark:to-gray-700 p-4 rounded-lg border border-cyan-100 dark:border-gray-600">
            <h3 className="font-medium text-gray-800 dark:text-white text-md mb-2">
              Travel Story Tips
            </h3>
            <ul className="text-xs text-gray-600 dark:text-gray-300 space-y-2">
              <li className="flex items-start">
                <span className="inline-block bg-cyan-100 dark:bg-cyan-800 text-cyan-600 dark:text-cyan-300 p-1 rounded mr-2 mt-0.5">
                  •
                </span>
        ...
        <div className="md:col-span-2 p-3 sm:p-5 border rounded-lg bg-white/50 dark:bg-gray-800/50 border-slate-200 dark:border-gray-700 shadow-sm">
          <AnimatePresence mode="wait">
            {activeStep === 1 && (
              <motion.div
                ...
                className="h-full"
              >
                <h3 className="text-base sm:text-lg font-semibold text-slate-800 dark:text-white mb-4 flex items-center">
                  <MdTitle className="mr-2 text-cyan-500" /> Title your memory
                </h3>
                <div className="bg-white dark:bg-gray-800 p-3 sm:p-5 rounded-lg shadow-sm border border-slate-200 dark:border-gray-700">
                  <input
                    type="text"
                    className="text-lg sm:text-2xl w-full text-slate-800 dark:text-white outline-none border-b-2 border-slate-200 dark:border-gray-600 focus:border-cyan-400 dark:focus:border-cyan-600 py-2 transition-all bg-transparent rounded-md"
                  ...
                  <p className="text-xs sm:text-sm leading-relaxed text-slate-500 dark:text-slate-400 mt-3">
                    Give your travel memory a catchy title that captures the
                  ...
                  {formCompleted.title && window.innerWidth < 768 && (
                    <motion.div
                      ...
                      animate={{ opacity: 1, scale: 1 }}
                      className="mt-4 bg-green-50 dark:bg-green-900/20 p-3 rounded-lg border border-green-100 dark:border-green-800 flex items-center text-center w-full"
                    >
                      <FiCheckCircle className="text-green-500 mr-2" />
                      <span className="text-green-700 dark:text-green-400 text-sm">
                        Title completed! Swipe left or use the navigation to
                        continue.
                      </span>
                    </motion.div>
                  )}
                  ...
                  <div className="mt-6 flex flex-col sm:flex-row justify-between gap-3">
                    <motion.button
                      className="w-full sm:w-auto bg-cyan-500 hover:bg-cyan-600 text-white px-5 py-2.5 rounded-lg transition-colors flex items-center justify-center shadow-sm min-h-[44px]"
                      onClick={() => {
            ...
            {activeStep === 2 && (
              ...
              >
                <h3 className="text-base sm:text-lg font-semibold text-slate-800 dark:text-white mb-4 flex items-center">
                  <MdCalendarToday className="mr-2 text-cyan-500" /> When did
                  this happen?
                </h3>
                <div className="bg-white z-50 dark:bg-gray-800 p-3 sm:p-5 rounded-lg shadow-sm border border-slate-200 dark:border-gray-700 max-w-md mx-auto">
                  <DataSelector date={visitedDate} setDate={setVisitedDate} />
                  <p className="text-xs sm:text-sm leading-relaxed text-slate-500 dark:text-slate-400 mt-3">
                    Select the date when you visited this location.
                  </p>
                  ...
                  {formCompleted.date && window.innerWidth < 768 && (
                    ...
                    >
                      <FiCheckCircle className="text-green-500 mr-2" />
                      <span className="text-green-700 dark:text-green-400 text-sm">
                        Date selected! Swipe left or use the navigation to
                        continue.
                      </span>
                    </motion.div>
                  )}
                  ...
                  <div className="mt-6 flex flex-col sm:flex-row gap-3">
                    <motion.button
                      className="w-full sm:w-auto border border-slate-300 dark:border-gray-600 hover:bg-slate-100 dark:hover:bg-gray-700 text-slate-700 dark:text-slate-200 px-5 py-2.5 rounded-lg transition-colors flex items-center justify-center min-h-[44px]"
                      onClick={() => {
                        setAutoAdvancePaused(true);
                        setActiveStep(1);
                      }}
            ...
            {activeStep === 3 && (
              ...
              >
                ...
                <div className="bg-white dark:bg-gray-800 p-3 sm:p-5 rounded-lg shadow-sm border border-slate-200 dark:border-gray-700 max-w-md mx-auto">
                  <ImageSelector
                    image={storyImg}
                  ...
                  />
                  <p className="text-xs sm:text-sm leading-relaxed text-slate-500 dark:text-slate-400 mt-3">
                    Upload a photo that best captures your travel experience.
                  </p>
                  ...
                  {formCompleted.image && window.innerWidth < 768 && (
                    ...
                    >
                      <FiCheckCircle className="text-green-500 mr-2" />
                      <span className="text-green-700 dark:text-green-400 text-sm">
                        Image added! Swipe left or use the navigation to
                        continue.
                      </span>
                    </motion.div>
                  )}
            ...
            {activeStep === 4 && (
              ...
              >
                <h3 className="text-base sm:text-lg font-semibold text-slate-800 dark:text-white mb-4 flex items-center">
                  <MdDescription className="mr-2 text-cyan-500" /> Tell your
                  story
                </h3>
                <div className="bg-white dark:bg-gray-800 p-3 sm:p-5 rounded-lg shadow-sm border border-slate-200 dark:border-gray-700 max-w-md mx-auto">
                  <textarea
                    className="w-full text-slate-800 dark:text-white outline-none border border-slate-200 dark:border-gray-600 rounded-md p-3 focus:border-cyan-400 dark:focus:border-cyan-600 focus:ring-2 focus:ring-cyan-100 dark:focus:ring-cyan-900/30 transition-all min-h-[120px] sm:min-h-[200px] bg-transparent text-sm sm:text-base"
                  ...
                  {formCompleted.story && window.innerWidth < 768 && (
                    ...
                    >
                      <FiCheckCircle className="text-green-500 mr-2" />
                      <span className="text-green-700 dark:text-green-400 text-sm">
                        Story written! Swipe left or use the navigation to
                        continue.
                      </span>
                    </motion.div>
                  )}
            ...
            {activeStep === 5 && (
              ...
              >
                ...
                <div
                  className="bg-white dark:bg-gray-800 p-3 sm:p-5 rounded-lg shadow-sm border border-slate-200 dark:border-gray-700 
                                                    max-w-md md:max-w-2xl lg:max-w-4xl mx-auto w-full"
                >
                  {/* Tag input */}
                  <TagInput
                  ...
                  <p className="text-xs sm:text-sm leading-relaxed text-slate-500 dark:text-slate-400 mt-3">
                    Add all the places you visited during this trip.
                  </p>

                  {/* Completion messages (mobile only) */}
                  {formCompleted.location && window.innerWidth < 768 && (
                    ...
                    >
                      <FiCheckCircle className="text-green-500 mr-2" />
                      <span className="text-green-700 dark:text-green-400 text-sm">
                        Locations added! Ready to save your memory.
                      </span>
                    </motion.div>
                  )}
                  ...
                  {completionPercentage() === 100 &&
                    window.innerWidth < 768 && (
                      <motion.div
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
                        className="mt-4 p-3 rounded-lg bg-gradient-to-r from-cyan-50 to-green-50 dark:from-cyan-900/20 dark:to-green-900/20 border border-cyan-100 dark:border-cyan-800 text-center w-full"
                      >
                  ...
                  {/* Navigation buttons */}
                  <div className="mt-6 flex flex-col sm:flex-row gap-3 justify-center sm:justify-between">
                    <motion.button
                      className="w-full sm:w-auto border border-slate-300 dark:border-gray-600 hover:bg-slate-100 dark:hover:bg-gray-700 
                                                    text-slate-700 dark:text-slate-200 px-5 py-2.5 rounded-lg transition-colors flex items-center justify-center min-h-[44px]"
                      onClick={() => {
                        setAutoAdvancePaused(true);
                        setActiveStep(4);
                      }}
                    ...
                    <motion.button
                      className={`w-full sm:w-auto px-4 sm:px-6 py-3 rounded-lg text-white flex items-center justify-center font-medium transition-all shadow-sm min-h-[44px] 
    ${
      loading
        ? "bg-cyan-400 dark:bg-cyan-600 cursor-not-allowed"
        : "bg-gradient-to-r from-cyan-500 to-cyan-600 dark:from-cyan-600 dark:to-cyan-700 hover:from-cyan-600 hover:to-cyan-700 dark:hover:from-cyan-500 dark:hover:to-cyan-600"
    }`}
                    ...
                    >
                      {loading ? (
                        ...
                        <>
                          {type === "add" ? (
                            <>
                              <MdAdd className="mr-2 text-xl shrink-0" />
                            ...
                            <>
                              <MdUpdate className="mr-2 text-xl shrink-0" />
                              <span className="truncate sm:whitespace-normal">
                                Update Memory
                              </span>
                            </>
